/*
  ZCORP PIN & ACCESS KEY CONFIGURATION (client-side demo)
  WARNING: client-side keys are visible in a public repo -> OK for demo; NOT secure for production.
*/
const ZCORP_PINS = {
  // Admin PIN (UI-only, stored client-side in this demo)
  adminPin: "ZCORP2026",
  ...
  // Pre-generated access keys (20 per plan). Main.js maps keys to plan/price/expiry.
  accessKeys: [
    // ONE-TIME (2500)
